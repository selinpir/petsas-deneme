...
namespace petsas2.Services
{
    ...
    {
        private readonly ApplicationDbContext _context; //EF ICIN
        private readonly UserManager<ApplicationUser> _userManager; //KULLANICI YONETIMI ICIN
        private readonly AuthenticationStateProvider _authStateProvider; //KIMLIK DOGRULAMA VS - MEVCUT KULLANICIYA ERISIR
        ...
        //HESAP EKLE-KAYIT OLAN KULLANICININ IKINCI ASAMASI
        public async Task SaveAsync(HesapBilgileri model)
        {
            ...
            if (mevcut == null)
            {
                ...
                model.HesapOlusturmaTarihi = DateTime.UtcNow; //OTO ALINIR
                model.IsCompleted = true; //DAHA SONRA KULLANMAK UZERE PROFILIN TAMAMLANDIGINI BELIRTILDI
